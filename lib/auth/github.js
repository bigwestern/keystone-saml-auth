...
var credentials = {
	clientID: '4fad542442f230983dfa', // process.env.GITHUB_CLIENT_ID,
	clientSecret: '64e33995a9caf57be861272d4931d60a678c42c2', // process.env.GITHUB_CLIENT_SECRET,
	callbackURL: 'http://localhost:3000/auth/confirm', // process.env.GITHUB_CALLBACK_URL
};
...
exports.authenticateUser = function(req, res, next) {
	...
	// if (_.has(req.query, 'cb')) {
		...
		passport.authenticate('github', { session: false }, function(err, data, info) {
			...
			console.log('IN THE AUTHENTICATE CALLBACK');
	...
	// 	console.log('Hand off to github via passport.authenticate.....')
